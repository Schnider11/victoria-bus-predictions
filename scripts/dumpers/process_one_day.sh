...
sort -t ',' -k 2,2 -k 3,3 -k 1,1 -k 6,6 -n /home/jack/uvic/honors-proj/csv/trips_${date}_abstract_no_dups.csv -o /home/jack/uvic/honors-proj/csv/trips_${date}_abstract_no_dups.csv
...
# Fix records
sort -t ',' -k 4,4 -k 3,3 -k 6,6h -k 7,7 -k 11,11n -k 13,13n /home/jack/uvic/honors-proj/csv/vehicleupdates_${date}.csv -o /home/jack/uvic/honors-proj/csv/vehicleupdates_${date}.csv
python fix_records vehicle /home/jack/uvic/honors-proj/csv/vehicleupdates_${date}.csv
